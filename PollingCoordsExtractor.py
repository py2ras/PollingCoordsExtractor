...
# Polling Location Coordinates from a list of
# Polling Location Addresses.
...
#   Improve _parseJsonResponse() method
#   Create Unit tests
...
class PollingLocationExtractor:
    ...
    def extractCoords(self):
        for address in self.addresses:
            ...
            print (latCoords, longCoords, formattedAddress, classifiers)
...
def main():
    ...
    pollingLocationExtractor = PollingLocationExtractor("YOUR_API_KEY")
    pollingLocationExtractor.readAddressesFromFile(filename)
    pollingLocationExtractor.extractCoords()
    pollingLocationExtractor.writeLocationsToFile("FultonPollingLocationAttrs.tsv")
    # pollingLocationExtractor.readResponsesFromFile("test.txt")
    # pollingLocationExtractor.getLocationAttributes("bounds")
    # pollingLocationExtractor.printOutLocations()
    # pollingLocationExtractor.writeResponsesToFile("responses.txt")
